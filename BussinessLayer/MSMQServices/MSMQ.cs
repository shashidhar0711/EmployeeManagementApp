    ...
    public class MSMQ
    {
        ...
        public void ReceiveFromQueue(object sender, ReceiveCompletedEventArgs e)
        {
            try
            {
                ...
                using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"C:\Users\Theja\source\repos\EmployeeManagementApp\BussinessLayer\MSMQServices\msmq.txt", true))
                {
                    file.WriteLine(data);
                }
